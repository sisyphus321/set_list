...
def gig_idx( dbh, gig_venue, gig_date ):
...
def setlist_create(dbh, setlist_file, gig_idx, set_num ):
...
if __name__ == "__main__":
    ...
    for setlist_file in sets:
        print(setlist_file)
        setlist_create(mc,setlist_file,gig_idx,set_number)
